  ...
  render(){
    ...
    return(
      <div className="container">
        ...
        <p>Select which ones you want. I'll save them for you.</p>
        </div>
        ...
        {colarr.map((c,i)=>{
          return (
            ...
            <input type="checkbox"
                disabled={!anyleft[i]}
                label={namearr[i]}
                onChange={this.toggleCheckbox.bind(null, i)}
                key={namearr[i]}
            />
            ...
            <svg width="50px" height="50px" xmlns="http://www.w3.org/2000/svg" version="1.1">
               <circle cx="20" cy="20" r="10" stroke="#333" strokeWidth="1" fill={c}/>
            </svg> 
        ...
        <input type="email" value={this.state.name} onChange={this.changeName}/>
        <button onClick={this.submit}>reserve these</button>
        <p>if you change your mind just refresh the page and redo</p>
        </div>
      </div>
      )
  }
