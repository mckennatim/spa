...
var withToggle = (0, _recompose.compose)((0, _recompose.withState)('toggledOn', 'toggle', false), (0, _recompose.withHandlers)({
...
var Status = withToggle(function (_ref4) {
  var status = _ref4.status,
      toggledOn = _ref4.toggledOn,
      toggle = _ref4.toggle;
  return _react2.default.createElement(
    'span',
    { onClick: toggle },
    status,
    toggledOn && _react2.default.createElement(StatusList, null)
  );
});

var Tooltip = withToggle(function (_ref5) {
  var text = _ref5.text,
      children = _ref5.children,
      toggledOn = _ref5.toggledOn,
      show = _ref5.show,
      hide = _ref5.hide;
  return _react2.default.createElement(
    'span',
    null,
    toggledOn && _react2.default.createElement(
      'div',
      { className: 'Tooltip' },
      text
    ),
...
var User = function User(_ref6) {
  ...
  return _react2.default.createElement(
    ...
    '\u2014',
    _react2.default.createElement(Status, { status: status })
  );
};
...
var App = function App() {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(User, { name: 'Timot', status: 'active' })
  );
};
