...
const postUniCoid=(co,ttoken)=>{
  let url= cfg.url.api+'/payroll/ckcoid'
  let options= {
...
export{fetchSettings, fetchCompany, postCompany, putPerson, newPerson, deletePerson, putCk, fetchCurrent, postUniCoid}