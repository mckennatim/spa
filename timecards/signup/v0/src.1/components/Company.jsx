...
class Company extends React.Component{
      ...
      .then((res)=>{
        if (res.qmessage){
          ...
          this.setState({firstday: res.firstday},()=>{
            setKeyVal({coid: res.coid, qmessage:res.qmessage, task:'signup'})
          })
        }
      })
  ...
  getwk = ()=>{
    this.alterCompanyYdate(this.state.wk)  
  }
  buzz=()=>{
    console.log('buzz()')
  ...
  getwk0 = ()=>{
    this.alterCompanyYdate(0)  
  }

  alterCompanyYdate = (wk)=>{
    fetchCompany(wk)
    .then((res)=>{
  ...
  render(){
    if (this.state.persons){
      ...
      const rndrdpersons = this.renderCompany()
      return(
        <div >
          <div style={style.he}>
            <div> 
