...
var pipe_1 = __webpack_require__(55);
/**
...
exports.aMessageCB = undefined;

var _paho = __webpack_require__(29);
...
var dmessage = (0, _util.el)('dmessage');

var mq = (0, _paho.makeMqtt)(_getCfg.cfg.devices);
mq.connect();

var aMessageCB = function aMessageCB(message) {
  var nmes = '[' + message.destinationName + ']' + message.payloadString;
  console.log(nmes);
  dmessage.innerHTML = nmes;
};

exports.aMessageCB = aMessageCB;
...
var _envmy = __webpack_require__(31);
...
var _storageLocal = __webpack_require__(33);
...
var testCfg = function testCfg() {
  var cred = { "email": "mckenna.tim@gmail.com", "token": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhcHBJZCI6InNocm9vbSIsImVtYWlsIjoibWNrZW5uYS50aW1AZ21haWwuY29tIn0.1n8rVxF5G-78H0KnsyEYTlZhMC6wdMYeu5rVnpzLN3o" };
  var cloc = '12ParleyVale';
...
exports.makeMqtt = undefined;

var _pahoMqtt = __webpack_require__(30);
...
var makeMqtt = function makeMqtt(devices) {
  var dmessage = 'duck';
  ...
  function connect() {
    client.connect({
      ...
      password: _getCfg.ls.getKey('token')
    });
  }
  function onConnect() {
...
module.exports = {"m":"base"}

/***/ }),
/* 32 */
/***/ (function(module, exports) {

module.exports = {"base":{"appid":"shroom","devices":["CYURD006","CYURD003"],"cbPath":"","mqtt_server":"services.sitebuilt.net/iotb/wss","mqtt_port":4333,"soauth":"https://services.sitebuilt.net/soauth","api":"https://services.sitebuilt.net/iotex/api"},"local":{"appid":"shroom","devices":["CYURD006","CYURD003"],"cbPath":"","mqtt_server":"services.sitebuilt.net/iotb/wss","mqtt_port":4333,"soauth":"https://services.sitebuilt.net/soauth","api":"https://services.sitebuilt.net/iotex/api"}}
...
module.exports = "<h1>hellow dog</h1>\r\n\r\n<p id=\"dmessage\">dog</p>";
...
exports.el = exports.deepObjModify = exports.parseQuery = exports.log = exports.isObservable = exports.render = exports.dog = exports.geta = undefined;
...
var _ofuncs = __webpack_require__(48);
...
*/
var aa=__webpack_require__(7),m=__webpack_require__(14),A=__webpack_require__(4),B=__webpack_require__(2),ca=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),ha=__webpack_require__(18),ia=__webpack_require__(19),C=__webpack_require__(5);
...
// eslint-disable-line no-unused-vars
var array = [1, 2, 3, 4, 5, 6]; // eslint-disable-line no-unused-vars
...
var en = 0;
evenNumbers.subscribe(function (x) {
  en += x;
});
console.log(en);

var deepObjModify = function deepObjModify(dotstr, val, obj) {
  if ((0, _index.geta)(dotstr, obj)) {
    var newobj = dotstr.split(".").slice(1).reduce(function (xs, x) {
      if (xs && xs[x]) {
        return xs[x];
      } else {
        return null;
