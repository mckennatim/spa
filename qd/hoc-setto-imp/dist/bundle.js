...
module.exports = {"local":{"appid":"t1","cbPath":"#registered","url":{"soauth":"localhost:7080","api":"localhost:3332/api"}},"https":{"appid":"t1","cbPath":"#registered","url":{"soauth":"https://services.sitebuilt.net/soauth","api":"https://services.sitebuilt.net/iotex/api"}},"production":{"appid":"t1","cbPath":"#registered","url":{"soauth":"https://services.sitebuilt.net/soauth","api":"https://services.sitebuilt.net/iotex/api"}}}
...
var _HocSetTimeout = __webpack_require__(43);
...
exports.HocSetTimeout = undefined;
...
var HocSetTimeout = function HocSetTimeout(Comp) {
	return function (_React$Component) {
		...
		function PP(props) {
			...
			_this.state = { isLoading: true, data: ['12parleyVale'] };
			return _this;
		}
		...
		_createClass(PP, [{
			...
			value: function componentDidMount() {
				...
				setTimeout(function () {
					_this2.setState(_extends({}, _this2.state, { isLoading: false }));
					console.log(_this2.state);
				}, 2000);
				setTimeout(function () {
					_this2.setState(_extends({}, _this2.state, { isLoading: true }));
					console.log(_this2.state);
				}, 4000);
			}
		}, {
...
exports.HocSetTimeout = HocSetTimeout;
