...
var WrpComp = function WrpComp(props) {
	console.log(props);
	var name = props.name,
...
var HocSetTimeout = function HocSetTimeout(WrpComp) {
	return function (_React$Component) {
		...
		function PP(props) {
			...
			_this.state = { isLoading: false, data: ['12parleyVale'] };
			return _this;
		}
		...
		_createClass(PP, [{
			...
			key: 'render',
			value: function render() {
				return _react2.default.createElement(WrpComp, _extends({}, this.props, this.state));
			}
		}]);
