...
const reset = {
  ...
  readyMessage: (prior, qstate, that)=>{
    if(geta('qstate.readystate.message',qstate)){
      that.setState({qmessage: qstate.readystate.message})
      prior.message = qstate.readystate.message
    }     
  },
  stateWhenUrlsrChanges: (prior, urlsr, qstate, that)=>{
