...
const multi =[
  ...
  {pri: 'DaySched', mul:[
    ['DaySched', 'SensorRelay'],
    ['DaySched', 'SensorRelay', 'AtLoc'],
    ['DaySched', 'SensorRelay', 'AtLoc', 'LocList']
  ]},
  {pri: 'WeekSched', mul:[
    ['WeekSched', 'DaySched'],
    ['WeekSched', 'DaySched', 'SensorRelay'],
    ['WeekSched', 'DaySched', 'SensorRelay', 'AtLoc']
  ]}
]
...
export {LocList, Login, About, Home, Dog, Registered, App, Nav, Zones, Zone, SensorRelay, WeekSched, DaySched, TimerCtl, SaveSched, AtLoc, multi, panes}
