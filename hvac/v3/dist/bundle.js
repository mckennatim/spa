...
exports.parseHash = exports.deepObjModify = exports.parseQuery = exports.log = exports.isObservable = exports.render = exports.dog = exports.geta = undefined;
...
var _storageLocal = __webpack_require__(29);

var _ofuncs = __webpack_require__(53);
...
var geta = function geta(path, props) {
  return path.split(".").slice(1).reduce(function (xs, x) {
...
exports.deepObjModify = _ofuncs.deepObjModify;
...
var _rxred = __webpack_require__(38);
...
(0, _rxred.createStore)(_store.initState).do(_utilities.log).subscribe(function (state) {
  console.log('doggy');
  exports.router = router = (0, _routing.routing)();
  console.log(router);
...
exports.storageLocal = undefined;
...
var stoLo = function stoLo(i, s, a) {
	return {
		i: i,
		s: s,
		a: a
...
exports.combineReducers = exports.createStore = exports.actionCreator = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var _Observable = __webpack_require__(0);

var _Subject = __webpack_require__(73);
...
var createStore = function createStore(initState) {
  return action$.flatMap(function (action) {
    return (0, _utilities.isObservable)(action) ? action : _Observable.Observable.from([action]);
  }).startWith(initState).scan(_reducers.rootReducer);
};
...
var actionCreator = function actionCreator(func) {
  return function () {
    ...
    action$.next(action);
    if ((0, _utilities.isObservable)(action.payload)) action$.next(action.payload);
    return action;
  };
};

var combineReducers = function combineReducers(reducersObject) {
...
var _navigo = __webpack_require__(99);
...
var routing = function routing() {
	...
	var router = new _navigo2.default(cfg.root, cfg.useHash);
	router.on({
		'loclist': function loclist() {
			(0, _actions.switchPage)({ rt: 'loclist', name: 'LocList', params: null });
		},
		'home/:locid': function homeLocid(params) {
			(0, _actions.switchPage)({ rt: 'home', name: 'Home', params: params });
		},
		'login': function login() {
			(0, _actions.switchPage)({ rt: 'login', name: 'Login', params: null });
		},
		'about': function about() {
			(0, _actions.switchPage)({ rt: 'about', name: 'About', params: null });
		},
		'*': function _() {
			(0, _actions.switchPage)({ rt: '', name: 'About', params: null });
		}
	}).resolve();
	return router;
};
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(23),A=__webpack_require__(6),B=__webpack_require__(5),ca=__webpack_require__(24),da=__webpack_require__(25),ea=__webpack_require__(26),ha=__webpack_require__(27),ia=__webpack_require__(28),C=__webpack_require__(7);
...
exports.dog = exports.deepObjModify = exports.evenNumbers = undefined;
...
var evenNumbers = _Observable.Observable.from(array).filter(function (x) {
	return x % 2 === 0;
});

var deepObjModify = function deepObjModify(str, val, obj) {
	val = val.trim();
	if (!val.match(/^[\[\{]/)) {
		val = '"' + val + '"';
	} else {
...
var Observable_1 = __webpack_require__(0);
var from_1 = __webpack_require__(35);
...
var tap_1 = __webpack_require__(78);
/* tslint:enable:max-line-length */
/**
...
var Observable_1 = __webpack_require__(0);
var scan_1 = __webpack_require__(85);
...
var Observable_1 = __webpack_require__(0);
var startWith_1 = __webpack_require__(88);
...
var startWith_1 = __webpack_require__(89);
/* tslint:enable:max-line-length */
/**
...
var from_1 = __webpack_require__(35);
var concatAll_1 = __webpack_require__(92);
/* tslint:enable:max-line-length */
/**
...
var _responsive = __webpack_require__(96);
...
var responsive = function responsive(state, action) {
  switch (action.type) {
    case 'PAGE_SWITCHED':
...
var _showRWD = __webpack_require__(101);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.showPage = function () {
      ...
      return (0, _showRWD.showRWD)(_this.props);
    };
...
// console.log('in showRWD');
var showRWD = function showRWD(state) {
  var elArr = [];
  var _state$responsive = state.responsive,
      types = _state$responsive.types,
      sizes = _state$responsive.sizes,
      browser = _state$responsive.browser,
      size = _state$responsive.size,
      page = _state$responsive.page;
  // console.log(page);

  var pageName = page.name;
  var browserTypeIdx = types.indexOf(browser);
  var panesPerType = compoi.panes[browserTypeIdx];
  var pageList = compoi.multi.filter(function (amul, i) {
    return amul.pri == pageName;
  });
  ...
  if (pageList.length == 0) {
    ...
    if (multiList.length == 0) {
      // if the multilist is empty
      var _singleElement = compoi[pageName](state);
      elArr.push(_singleElement);
    } else {
      //use the array matching the panesPerType size and add all its names to the element arrray
      var elList = multiList[0].map(function (pgStr, i) {
        var pg = compoi[pgStr](state);
        return pg;
      });
      elArr = elList;
    }
...
exports.panes = exports.multi = exports.About = exports.Login = exports.LocList = exports.Home = undefined;

var _About = __webpack_require__(103);

var _Home = __webpack_require__(104);

var _LocList = __webpack_require__(105);
...
function Home(props) {
	var locid = props.responsive.page.params.locid;
	// const {locid} = 'llama'
...
var _getCfg = __webpack_require__(107);
...
var url = (0, _getCfg.url2cb)('#login');
...
exports.url2cb = exports.aurl = exports.cfg = exports.ls = undefined;

var _envmy = __webpack_require__(108);
...
var aurl = cfg.url.soauth + "/spa/" + cfg.appid + "?apiURL=" + encodeURIComponent(cfg.url.api) + "&cbPath=" + encodeURIComponent(cfg.cbPath);

var url2cb = function url2cb(cb) {
...
exports.cfg = cfg;
exports.aurl = aurl;
exports.url2cb = url2cb;

/***/ }),
/* 108 */
/***/ (function(module, exports) {

module.exports = {"m":"local"}

/***/ }),
/* 109 */
/***/ (function(module, exports) {

module.exports = {"local":{"appid":"hvac","cbPath":"#home","url":{"soauth":"https://services.sitebuilt.net/soauth","api":"https://services.sitebuilt.net/iotex/api"}},"production":{"appid":"hvac","cbPath":"#home","url":{"soauth":"https://services.sitebuilt.net/soauth","api":"https://services.sitebuilt.net/iotex/api"}}}
