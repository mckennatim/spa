...
import {createMqttStore, createBlankQdata, qdataAsArray, processMqttMessage, createSubscriptions} from '../src/services/interface'
...
describe('mqtt', ()=>{
  ...
  it('tries createSubscription(devs)',(done)=>{
    ...
    let res = createSubscriptions(devs)
    console.log(res)
