...
class TimeCard extends React.Component{
  ...
  checkStatus =()=>{
    const {hrs, jchrs}=this.props.tcard
  ...
  changeStatus=(status, showsub)=>{
    ...
    let nwstat = {...this.props.tcard.wstat}
    nwstat.status = status
    nwstat.hrs=drnd(this.props.tcard.hrs.reduce((t,h)=>t+h,0))   
    nwstat.wprt=`${this.props.yr}-W${this.props.week.toString().padStart(2,'0')}`
    putTcardWk(nwstat)
