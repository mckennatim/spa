...
class TimeCard extends React.Component{
    ...
    fetchTcard(wk)
      .then((res)=>{
        ...
        if (res.message){
          ...
          this.setState({week:wk, wkarr:res.wkarr, hrs:res.hrs, jchrs:res.jchrs, jobs:res.jobs, wstat:res.wstat}, this.checkStatus())
        }
      })
  }
  ...
  render(){
    ...
    if(this.emailId){  
      ...
      return(
      <div >
        <div style={{height:'60px', background:'silver'}}>
